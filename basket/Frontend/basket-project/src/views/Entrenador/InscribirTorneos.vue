            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div v-if="rosterActual.length > 0" class="bg-white rounded-2xl shadow-sm border border-indigo-200 p-6 overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div v-for="jugador in rosterActual" :key="jugador.id_jugador" class="flex items-center p-3 bg-gray-50 rounded-xl border border-gray-100">
                            <div class="w-10 h-10 rounded-full bg-white text-indigo-800 flex items-center justify-center font-black text-lg mr-3 shadow-sm border border-gray-200">
                                {{ jugador.numero_camiseta }}
                            </div>
                            <div class="flex-1">
                                <p class="font-bold text-gray-900 flex items-center text-sm">
                                ...
                                <p v-if="jugador.es_capitan" class="text-xs text-yellow-600 font-bold mt-1">Líder del equipo y representante ante la organización.</p>
